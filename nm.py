...
def hapus():
        print "\033[1;96m[!] \x1b[1;91mClear"
        os.system ("clear")
...
print "\033[1;34m ============================"
print "\033[1;34m Author : Upil Koclok"
print "\033[1;34m Github : http://github.com/pilek69"
print "\033[1;34m ============================"

CorrectUsername  =  "UPIL"
CorrectPassword  =  "KOCLOK"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open 085800575938')
    else:
...
def menu():
	...
	print "\033[1;32;40m[2] \033[1;33;40m══Update Upil"																														
...
def pilih_super():
	...
	jalan('                    \033[1;97mUpil start cloning Wait...')
	print  "  \033[1;36;48m ●💋══════════════════◄►══════════════════💋●" 
